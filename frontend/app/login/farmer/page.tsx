...
export default function FarmerLogin() {
  ...
  return (
    <div className="min-h-screen bg-[#020f09] flex items-center justify-center overflow-hidden relative text-white">
      ...
      />
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[400px] blur-[120px] rounded-full pointer-events-none bg-green-500/8" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[300px] blur-[100px] rounded-full pointer-events-none bg-emerald-900/20" />
      ...
      <svg className="absolute bottom-8 right-8 opacity-10 w-16 h-16" viewBox="0 0 64 64">
        <polygon points="32,4 60,18 60,46 32,60 4,46 4,18" fill="none" stroke="#4ade80" strokeWidth="1" />
      </svg>
        ...
        >
          ...
          >
            ...
            <div className="text-center mb-10">
              ...
              {/* Role badge — farmer accent: #4ade80 */}
              <div className="inline-flex items-center gap-2 mt-3 px-4 py-1.5 rounded-full border border-[#4ade80]/30 bg-[#4ade80]/5">
                <span className="text-base">🌾</span>
                <span className="text-[11px] tracking-[0.2em] font-mono text-[#4ade80] uppercase">Farmer Portal</span>
              </div>
            </div>
              ...
              <div>
                ...
                <div
                  ...
                  style={{
                    boxShadow: focused === "email"
                      ? "0 0 0 1.5px #4ade80, 0 0 20px -5px rgba(74,222,128,0.3)"
                ...
                >
                  ...
                  <input
                    ...
                    placeholder="farmer@herbtrace.io"
            ...
            <div className="mt-6 pt-6 border-t border-green-900/20 text-center text-[10px] font-mono text-green-900/40 tracking-widest">
              END-TO-END ENCRYPTED · PRODUCER MODULE
            </div>
